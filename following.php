...
$z=0;
$stmt = $pdo->query("SELECT * FROM users natural join follower where followername='".$_SESSION["name"]."'");
    ...
    ?>
        ...
        <div class="card">
            <div class="card-header" id="headingOne">
              ...
              <a href="profiles.php?name=<?php echo($row['name'])?>">
              <span style="font-size:20pt;"><?php echo(ucfirst($row['name']))?></span></div>
            </a>
              <span style="font-size:10pt;color:#808080;float:right;"><a href="unfollow.php?name=<?php echo($row['name'])?>">Unfollow<i class="fas fa-user-minus"></i></a></span>
              </button>
                </h2>
            </div>
